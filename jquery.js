$(document).ready(function() {
  ...
  let childrenData = [
    { name: "Mayanda Bella", program: "Infant Care", age: "5 Bulan", img: "img/anak1.jpg" },
    { name: "Arya Dinata", program: "Toddler Program", age: "2 Tahun", img: "img/anak2.jpg" },
    { name: "Arumi Khanza", program: "Pre-School Program", age: "3 Tahun", img: "img/anak3.jpg" },
    { name: "Rafif Akbar", program: "Pre-Kindergarten", age: "5 Tahun", img: "img/anak4.jpg" }
  ];
